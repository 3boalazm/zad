...
.afs-virtue { font-size: 13px; color: var(--gold-dark,#b87200); background: rgba(201,161,74,.08); padding: 8px 12px; border-radius: 10px; margin-bottom: 12px; line-height: 1.6; }
