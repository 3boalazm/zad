/* ════════════════════════════════════════════════════════════
   فاحص الكونتراست v3 — أداة تشخيص لمطوّر زاد
...
(function(){
  ...
  function buildReportText(rep){
    var L=[];
    L.push('═══ تقرير فاحص الكونتراست — زاد ═══');
